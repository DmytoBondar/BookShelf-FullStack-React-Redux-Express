...
const Register = () => {
    ...
    return (
        <div className="flex items-center min-h-screen p-4 bg-cyan-900 lg:justify-center">
            <div
            ...
            >
                ...
                >
                    <div className="flex gap-2 my-3 text-4xl font-bold tracking-wider text-center">
                        <img width="40" className='rounded-full' src={Logo} alt="" />
                        <Link to="/">BOOKSHELF</Link>
                    </div>
                    <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi consequuntur accusamus labore iure nobis distinctio cupiditate corrupti incidunt quibusdam numquam!
                    </p>
                ...
                <div className="p-5 bg-white md:flex-1">
                    ...
                    <div className="flex flex-col space-y-1">
                            <label htmlFor="userName" className="text-sm font-semibold text-gray-500">Name</label>
                            <input
                        ...
                        <div className="flex flex-col space-y-1">
                            <label htmlFor="phoneNumber" className="text-sm font-semibold text-gray-500">Phone Number</label>
                            <input
                                onChange={(e) => handleChange(e)}
                                type="text"
                                id="phoneNumber"
